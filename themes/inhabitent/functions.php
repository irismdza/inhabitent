...
function red_starter_scripts() {
	...
	//font awesome
	wp_enqueue_style( 'font-awesome-cdn', '//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), '4.4.0' );
	...
	wp_enqueue_script( 'jquery' );
     ...
     if ( is_page( 'home' ) || is_page('about') || is_singular('adventures') ) {
		...
		// jquery toggle search
		wp_enqueue_script( 'red_comments', get_template_directory_uri().'/js/toggle.js', array( 'jquery'), '2.0', true);
	 };
